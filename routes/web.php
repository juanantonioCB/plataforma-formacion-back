...
Route::middleware('keycloak-web')->group(function() {
    ...
    Route::controller(Controller::class)->group(function() {
        ...
        Route::get('cursos', [Controller::class, 'cursos'])->name('cursos');
        Route::get('contenido', [Controller::class, 'contenido'])->name('contenido');
        Route::get('administradores', [Controller::class, 'administradores'])->name('administradores');
        Route::get('teachers', [Controller::class, 'teachers'])->name('teachers');
...
Route::middleware('auth')->group(function() {
    ...
    Route::controller(PageController::class)->group(function() {
        Route::get('/dashboard1', 'dashboardOverview1')->name('dashboard-overview-1');
