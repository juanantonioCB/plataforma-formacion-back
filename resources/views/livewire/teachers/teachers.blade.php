<div>
    @if($view=='lista')
        ...
        <div class="intro-y flex flex-col sm:flex-row items-center mt-4">
            <h2 class="text-lg font-medium mr-auto">Lista de Teachers</h2>
                                ...
                                <tr class=" ">
                                    <td class=" w-1/6">
                                        <div class="flex justify-center items-center">
                                            <button class="flex items-center mr-3 text-p_s_azul" wire:click="edit('{{ $teacher->id }}')">
                                            ...
                                            <button class="flex items-center text-p_p_rojo" wire:click="delete('{{ $teacher->id }}')">
                                    ...
                                    <td class="">
                                        <div class="flex justify-center">
                                            @if ($teacher->avatar)
                                                <img alt="" class="rounded-full h-8" src="{{ $teacher->avatar }}">
                                            @else
    ...
    @if($view=='editar')
        ...
        <div class="intro-y flex flex-col sm:flex-row items-center mt-4">
            @if ($teacher_id)
                <h2 class="text-lg font-medium mr-auto">Editar teacher: <span class="">{{ $nombreTeacher }}</span></h2>
            @else
                <h2 class="text-lg font-medium mr-auto">Insertar teacher</h2>
            @endif
        </div>
        ...
        <div class="grid grid-cols-12 gap-6 mt-5 box p-5">
            <div class="col-span-12 xl:col-span-6">
                <div class="mt-4">
                    ...
                    <input type="text" class="form-control w-full" placeholder="Email..." :value="old('email')" wire:model="email" autofocus maxlength="255" {{ ($this->teacher_id) ? 'disabled' : '' }}>
                </div>
            </div>
            <div class="col-span-12 xl:col-span-6">
                <div class="mt-4">
    ...
    <x-modaldialog tipo="error" titulo="Eliminación de Teacher" :mensajeconfirmacion="$confirmingNameDelete" nombreaccion="deleteTeacher" :idaccion="$confirmingIdDelete" textoaccion="Borrar" ventana="borrado"></x-modaldialog>
